...
router.post('/forgot', async (req, res) => {
  try {
    ...
    const msg = {
      to: user.email,
      from: 'Pullit <noreply@pullit.com>',
      subject: '[pullit] password reset request',
      text:
...
router.post('/reset/:token', async (req, res) => {
  ...
  try {
    ...
    const msg = {
      to: user.email,
      from: 'Pullit <noreply@pullit.com>',
      subject: '[pullit] your password has been changed',
      text:
...
router.post('/email', auth, async (req, res) => {
  try {
    ...
    const msg = {
      to: user.email,
      from: 'Pullit <noreply@pullit.com>',
      subject: '[pullit] your email address has been changed',
      text:
