...
function Search() {
  ...
  return (
    <Container className="flex justify-center gap-6">
      <Head>
        <title>
          pullit: search results -
          {q}
        </title>
        <meta name="description" content="Pullit is a network of communities based on people's interests. Find communities you're interested in, and become part of an online community!" />
        <meta property="og:title" content="pullit" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content={`https://${process.env.NEXT_PUBLIC_DOMAIN_NAME}/`} />
        <meta property="og:description" content="Pullit is a network of communities based on people's interests. Find communities you're interested in, and become part of an online community!" />
      </Head>
        ...
        {!isLoading && data && data.pages[0].posts.length === 0
                        ...
                        <Card>
                          <div className="p-4 text-center">
                            <h6 className="pb-4">
                              If there aren&apos;t any search results for “
                              {q}
                              ”, does it even exist?
                            </h6>
                            <div className="content">
                              Looks like there aren&apos;t any results for “
                              {q}
                              ”. Try double-checking your spelling or searching for a related topic.
                            </div>
                          </div>
                        </Card>
                        )}
